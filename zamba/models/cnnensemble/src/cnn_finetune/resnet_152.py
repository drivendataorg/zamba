...
from tensorflow.python.keras.layers import Input, Dense, Convolution2D, MaxPooling2D, AveragePooling2D, ZeroPadding2D, Dropout, Flatten, add, Reshape, Activation, GlobalAveragePooling2D
...
def resnet152_model(img_shape, num_classes=None):
    """
