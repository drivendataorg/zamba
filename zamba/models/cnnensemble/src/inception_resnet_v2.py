...
# from tensorflow.python.keras._impl.keras.imagenet_utils import _obtain_input_shape
# from tensorflow.python.keras._impl.keras.imagenet_utils import decode_predictions
