...
def test_image(model, chimp_image_path, tmp_path):
    ...
    if model == "chimps":
        ...
        # output to disk
        assert anatomy_info.shape in [(2, 44), (1, 44)]  # depends on number of chimps identified; varies by version
...
def test_video(model, chimp_video_path, tmp_path):
    ...
    if model == "chimps":
        ...
        # output to disk
        assert anatomy_info.shape[0] in [8, 9, 10]  # depends on number of chimps identified; varies by version
